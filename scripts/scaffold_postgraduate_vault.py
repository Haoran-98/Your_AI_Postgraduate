...
DOMAIN_TRANSLATIONS = {
    ...
    "AI学伴": "Education_AI",
    "媒体作者认知画像": "Media_Information_AI",
    "战场AI认知建模": "Military_AI",
    "认知衰减建模评估": "Human_Cognition_AI",
    "智能体环境生成": "Agent_Systems_AI",
    "群体认知图谱": "Collective_Intelligence_AI",
    "因果LLM推理": "Causal_AI",
    "因果认知行为模拟数据集": "Behavioral_Simulation_AI",
    "AI科研偏见": "AI_For_Science",
    "军事": "Military",
